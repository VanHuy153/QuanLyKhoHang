...
<head>
  ...
  <title>Didongthongminh - Quản lý phiếu xuất</title>
    ...
    <section class="content">
      <div class="container-fluid">
        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
          <a href="./ThemPhieuXuat.php" class="btn btn-info mb-1" role="button">Thêm</a>
          <div class="row">
                              ...
                              <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                                  ...
                                  <thead>
                                    <tr>
                                      ...
                                      <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                          aria-label="Platform(s): activate to sort column descending" aria-sort="ascending">Loại xuất</th>
                                      <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                              ...
                              while ($row = mysqli_fetch_assoc($query)){
                                ?>
                                    <tr class="odd">
                                      ...
                                      <td class="sorting_1"><?php echo $row['maDonXuat'] ?></td>
                                      <td class="sorting_1"><?php echo $row['ngayLapHoaDonXuat'] ?></td>
                                      <td class="sorting_1"><?php echo $row['loaiXuat'] ?></td>
                                      ...
                                      <td><a href="ThongTinPhieuXuat.php?id=<?php echo $row['maDonXuat']?>">Chi Tiết</a></td>
                                      <?php 
                                      if($row['TrangThai']!='Đã huỷ'){
                                      ?>
                                      <td><a style="color: red;" href="HuyPhieuXuat.php?id=<?php echo $row['maDonXuat']?>">Huỷ</a></td>
                                      <?php }; ?>
                                    </tr>
                                <?php
                              }
                          }else echo "Chưa Có Phiếu xuất nào";
                        ?>
                        </tbody>
                        <tfoot>
                          </tfoot>
