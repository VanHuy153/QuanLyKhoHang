...
if($id)
    {
      ...
      join nhanvien on hoadonnhaphang.maNhanVien=nhanvien.maNhanVien
...
?>
  ...
  <title>Didongthongminh - Thông tin phiếu nhập</title>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Thông tin phiếu nhập</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
          <div class="card card-default">
            <div class="card-header">
              <h1 class="card-title">Chi Tiết Phiếu nhập</h1>
            ...
            <div class="card-body">
              <div>
                <strong>
                  <div>
                    Mã Phiếu Nhập:
                    <span id="maphieu"><?php echo $row['maHoaDonNhap']?> </span>
                  </div>
                  <div>
                    Ngày Nhập:
                    <span id="NgayNhap"> <?php echo $row['ngayLapDonNhap']?> </span>
                  </div>
                  <div>
                    Trạng thái:
                    <span id="TenNguoiNhap"> <?php echo $row['loaiNhap']?> </span>
                  </div>
                  <div>
                    Tên người nhập:
                    <span id="TenNguoiNhap"> <?php echo $row['tenNhanVien']?> </span>
                  </div>
                  <div>
                    Tên người giao:
                    <span id="TenNguoiGiao"> <?php echo $row['nguoiGiao']?> </span>
                  </div>
                  <div>
                    Địa chỉ nhập:
                    <span id="DiaChiNguoiNhap"> <?php echo $row['diaChiNhap']?> </span>
                  </div>
                  <div>
                    SĐT nơi nhập:
                    <span id="SĐTNguoiNhap"> <?php echo $row['sdtNoiNhap']?> </span>
                  </div>
                  <div>
                    Mã kho:
                  ...
                  <table id="example2" class="table table-bordered table-hover dataTable dtr-inline"
                    ...
                    <thead>
                      <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                            aria-label="Browser: activate to sort column ascending">Giá nhập</th>
                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                    ...
                    <?php
                          ...
                          $sql = "select tenSanPham,donGiaNhap,soLuongNhap from sanphamnhap 
                          join sanpham on sanphamnhap.maSanPham=sanpham.maSanPham
                          where maHoaDonNhap = $id";
                              ...
                              while ($row = mysqli_fetch_assoc($query)){
                                ?>
                                    <tr class="odd">
                                      ...
                                      <td class="sorting_1"><?php echo $row['soLuongNhap'] ?></td>
                                      <td class="sorting_1"><?php echo $row['donGiaNhap'] ?></td>
                                      <td class="sorting_1"><?php echo $row['soLuongNhap']*$row['donGiaNhap'] ?> VND</td>
                                    </tr>
                                <?php
                                $tongTien+=$row['soLuongNhap']*$row['donGiaNhap'];
                              }?>  <tr class="odd">
                                  <th class="sorting_1 text-center" colspan="4">Tổng Tiền</th>
                                  <td class="sorting_1"><?php echo $tongTien ?> VND</td>
                                </tr>
                            <?php 
