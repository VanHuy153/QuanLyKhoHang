...
if (isset($_POST['loaiTK'])){
  $loaiTK=$_POST['loaiTK'];
  if($loaiTK=='Tháng'){
    header('Location: ThongKeBaoCaoSub.php?id=1');
  }else{
    header('Location: ThongKeBaoCaoSub.php?id=2');
  }
}
?>
                ...
                <div class="col-md-6" data-select2-id="41">
                  <form action="" method="POST" role="form">
                    <div class="form-group">
                      <label>Thông Kê Theo:</label>
                      <select type="submit" name="loaiTK" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                        <option data-select2-id="3">Năm</option>
                        <option data-select2-id="42">Tháng</option>
                      </select>
                    </div>
