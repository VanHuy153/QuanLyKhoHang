                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        ...
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                            aria-label="Rendering engine: activate to sort column ascending">Mã sản phẩm</th>
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                            aria-label="Rendering engine: activate to sort column ascending">Tên sản phẩm</th>
                        <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                    ...
                    <?php
                        ...
                        $sql = "select * from sanpham_kho join sanpham on sanpham_kho.maSanPham = sanpham.maSanPham where sanpham_kho.maKho = ".$id;
