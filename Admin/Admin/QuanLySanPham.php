...
<head>
  ...
  <title>Didongthongminh - Quản lý sản phẩm</title>

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleais.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome Icons -->
    ...
    <section class="content">
      <div class="container-fluid">
        <div id="example2_wrapper" class="dataTables_wrapper dt-bootstrap4">
          <a href="./themsanpham.php" class="btn btn-info mb-1" role="button">Thêm Sản phẩm</a>
          <div class="row">
              ...
              <table id="example2" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                        aria-label="Rendering engine: activate to sort column ascending">Avatar</th>
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                    ...
                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="2"
                        aria-label="Browser: activate to sort column ascending">Tùy chỉnh</th>
                  </tr>
                </thead>
                <tbody>
                <?php
                        ...
                        if ($query){
                            ...
                            while ($row = mysqli_fetch_assoc($query)){
                              ?>
                                <tr>
                                  <td><?php echo $dem++?></td>
                                  <td><img src="<?php echo $row['anhMinhHoa']?>" alt="Avatar" width="100"></td>
                                  <td><?php echo $row['tenSanPham']?></td>
                                  <td><?php echo $row['dungLuong']?></td>
                                  <td><?php echo $row['mauSac']?></td>
                                  <td><a href="themSanPham.php?id=<?php echo $row['maSanPham']?> ">Sửa</a></td>
                                  <td><a href="xoasanpham.php?id=<?php echo $row['maSanPham']?> ">Xóa</a></td>
                                </tr>
                              <?php
                            }
                        }
