...
if (isset($_POST['lydo']))
{
    ...
    {
        $ld = $_POST['lydo'];
        $sql = "select maKho, loaiNhap, maSanPham, soLuongNhap from hoadonnhaphang 
        join sanphamnhap on hoadonnhaphang.maHoaDonNhap=sanphamnhap.maHoaDonNhap
        where hoadonnhaphang.maHoaDonNhap = $id";
        ...
        mysqli_query($conn,"update hoadonnhaphang
