...
?>
  ...
  <title>Didongthongminh - Sửa sản phẩm</title>
              ...
              <div class="col-md-6" data-select2-id="41">
                <form action="tuyChinhSanPham.php" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                          <input hidden name="maSanPham" <?php if($data){ echo "value=\"".$data['maSanPham']."\"";} ?> class="form-control select2 select2-hidden-accessible" type="text" placeholder="Nhập tên của sản phẩm...">
                        </div>
                    <div class="form-group">
                      ...
                      <select name="maDanhMuc" class=" form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="form-group">
                          ...
                          <input name="tenSanPham" <?php if($data){ echo "value=\"".$data['tenSanPham']."\"";} ?> class="form-control select2 select2-hidden-accessible" type="text" placeholder="Nhập tên của sản phẩm...">
                        </div>
                        <div class="form-group">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file">
                                <input name="anhMinhHoa" type="file" class="custom-file-input" id="exampleInputFile" <?php if($data){ echo "value=\"".$data['anhMinhHoa']."\"";} ?> >
                      ...
                      <select name="maHangSX" class=" form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                        <?php
                        $query = mysqli_query($conn, "select * from `hangsanxuat`");
                        while ($row = mysqli_fetch_array($query)) {
                        ?>
                          <option value="<?php echo $row['maHangSX']; ?>" <?php if($data && $data['maHangSX'] == $row['maHangSX']) echo "selected"?> ><?php echo $row['tenHangSX']; ?></option>
                        <?php
                        }
                        ?>
                      </select>
