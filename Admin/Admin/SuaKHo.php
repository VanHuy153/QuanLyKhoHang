        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Sửa Kho</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Chỉnh sửa thông tin kho</h3>
            ...
            <div class="row">
              ...
              <form action="tuyChinhKho.php" method="POST" enctype="multipart/form-data">
                <div class="form-group">
                  <input name="maKho" <?php if($data) echo "value=\"".$data['maKho']."\""; ?> class="form-control select2 select2-hidden-accessible" type="hidden" value="SP01">
                </div>
                <div class="form-group">
                  <label>Tên kho</label>
                  <input name="tenKho" <?php if($data) echo "value=\"".$data['tenKho']."\""; ?>  class="form-control select2 select2-hidden-accessible" type="text" value="Iphone X">
                </div>
                <div>
                  <label>Địa chỉ kho</label>
                  <input name="diaChiKho" <?php if($data) echo "value=\"".$data['diaChiKho']."\""; ?>  class="form-control select2 select2-hidden-accessible" type="text" value="5">
                </div>
                <div>
                  <label>Số điện thoại kho</label>
                  <input name="sdtKho" <?php if($data) echo "value=\"".$data['sdtKho']."\""; ?>  class="form-control select2 select2-hidden-accessible" type="text" value="5">
                </div>
